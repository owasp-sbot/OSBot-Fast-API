...
#         return_type  = endpoint.response_schema or 'Dict'
...
#         return method_code
#
#     def _build_method_params(self, endpoint: Schema__Endpoint__Contract           # Endpoint to build params for
#                            ) -> str:                                              # Build method parameters string
#
#         params = []
#                                                                                   # Add path parameters
...
#                 param_str   = f", {param.name}: Optional[{param.param_type}] = {default_val}"
#             params.append(param_str)
#                                                                                   # Add request body if present
#         if endpoint.request_schema:
#             params.append(f", request: {endpoint.request_schema}")
#
#         return ''.join(params)
#
...
#         return handling
#
#     def _build_response_handling(self, endpoint: Schema__Endpoint__Contract     # Endpoint to build response handling for
#                                ) -> str:                                        # Build response handling
#
#         if endpoint.response_schema:
#             return f'''
#                                                                                 # Return typed response
#         if result.json:
#             return {endpoint.response_schema}.from_json(result.json)
#         else:
...
#
#     def _get_schema_imports(self, endpoints: List[Schema__Endpoint__Contract]   # Endpoints to extract schemas from
#                           ) -> str:                                             # Get import statements for schemas used by endpoints
#
#         schemas = set()
#
#         for endpoint in endpoints:
#             if endpoint.request_schema:
#                 schemas.add(endpoint.request_schema)
#             if endpoint.response_schema:
#                 schemas.add(endpoint.response_schema)
#
#         if not schemas:
#             return ""
#                                                                                # For now, assume schemas are available in a schemas module
#                                                                                # In practice, this would need to be configured
#         imports = []
#         for schema in schemas:
#             imports.append(f"# from ..schemas import {schema}")
#
#         return '\n'.join(imports)