...
# ═══════════════════════════════════════════════════════════════════════════════
# Test Double: Real implementation of Fast_API__Service__Registry__Client__Base for testing
# ═══════════════════════════════════════════════════════════════════════════════


class Fake__Client__Beta(Fast_API__Service__Registry__Client__Base):                  # Test double for second client type

    def setup_from_env(self) -> 'Fake__Client__Beta':
        return self
