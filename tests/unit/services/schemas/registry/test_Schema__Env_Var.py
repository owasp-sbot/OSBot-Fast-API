# ═══════════════════════════════════════════════════════════════════════════════
# Tests for Schema__Env_Var and List__Env_Vars
# Validates environment variable schema and collection
# ═══════════════════════════════════════════════════════════════════════════════
...
class test_Schema__Env_Var(TestCase):

    def test__init__(self):                                                     # Test auto-initialization
        with Schema__Env_Var() as _:
            assert type(_)          is Schema__Env_Var
    ...
    def test__with_values(self):                                                # Test with explicit values
        env_var = Schema__Env_Var(name     = 'URL__TARGET_SERVER__CACHE',
                                  required = True                        )
    ...
    def test__optional_env_var(self):                                           # Test optional env var
        env_var = Schema__Env_Var(name     = 'API_KEY__OPTIONAL',
                                  required = False               )
